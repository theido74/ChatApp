...
## New Features
* End-to-End Database OpenTelemetry
* Transaction Priority
* Metrics Filtering by Level
* OracleConnection SetSSO(), SetPEM(), and SetP12() APIs
* TLS State Transfer

## Bug Fixes in Oracle.ManagedDataAccess 23.26.200
* Bug 39061520 - ORACLEDECIMAL.DIVIDE() RESULTS IN OVERFLOWEXCEPTION FOR REPEATING DECIMAL VALUE EVEN IF SUPPRESSGETDECIMALINVALIDCASTEXCEPTION=TRUE 
* Bug 39000111 - ORA-25707 WHEN THE TOKEN CONTAINS BASE64URL ENCODED CHARACTERS
* Bug 39022265 - INTERMITTENT HANG ON SOCKET.READ INITIATED BY ORACLECONNECTION.CLOSE() 
* Bug 38922724 - INTERMITTENT HANG WITHIN TRANSPORT HEALTH CHECK INITIATED BY ORACLECONNECTION.OPEN() & CLOSE() 
* Bug 38151399 - ORACLEDATASOURCEBUILDER NOT SETTING ACTIONNAME, CLIENTID, CLIENTINFO, AND MODULENAME CORRECTLY 
